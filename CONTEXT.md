...
Started from the [ts-template](https://github.com/ysm-dev/ts-template) scaffold, whose purpose was to make agent-generated code safe to merge. The vocabulary below is still about that enforcement machinery — gates and exceptions — rather than this project's own domain. Replace it with real domain vocabulary as the project takes shape.
